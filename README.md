...
<p>
  ...
  <!-- loc:start --><img src="https://img.shields.io/badge/lines_of_code-237045-lightgrey?style=flat" alt="237045 lines of code" /><!-- loc:end -->
</p>
...
- **39 тем, 219 концептов, каталог по разделам.** Python (от ООП и дескрипторов до GIL и конкурентности), алгоритмы, базы данных (SQL, индексы, масштабирование), Web и API, архитектура, ML и AI, инструменты. Плюс курируемые треки, фасетные фильтры и полнотекстовый поиск.
...
- **Интервальное повторение.** Флэшкарды с FSRS-планировщиком (ts-fsrs) по всем 39 темам.
...
http://localhost:5173 - в репозитории 39 тем (`sql-fundamentals`, `python-oop`, `db-indexes` и др.).
